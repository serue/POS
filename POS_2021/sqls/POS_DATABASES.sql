...
CREATE TABLE SUB_CATEGORY(
	...
	CATEGORY VARCHAR(255) NOT NULL
			...
			CREATE TABLE TRANS_DETAILS(
				...
				BARCODE VARCHAR(50) NOT NULL REFERENCES INVENTORY(BARCODE) ON UPDATE CASCADE,
				QUANTITY DECIMAL(18,2) NOT NULL,
				AMOUNT DECIMAL(18,2) NOT NULL,
				PRIMARY KEY(ID)
				);
			...
			CREATE TABLE BASE_CURRENCY(
				...
				CURRENCY VARCHAR(100)  NOT NULL UNIQUE ,
				SYMBOL VARCHAR(50) NOT NULL,
				RTGS_RATE DECIMAL(18,2) NOT NULL,
				PRIMARY KEY(ID)
				);
			...
			CREATE TABLE TAX(
				ID INT IDENTITY PRIMARY KEY,
				COMPANY VARCHAR(255) NOT NULL REFERENCES COMPANY(NAME) ON UPDATE CASCADE,
			...
			CREATE TABLE OTHER_METHODS(
				ID INT IDENTITY PRIMARY KEY,
				TRANSACTION_ID VARCHAR(100) REFERENCES TRANSACTIONS(TRANSACTION_ID) ON UPDATE CASCADE,
				METHOD VARCHAR(100) REFERENCES M_PAYMENTS(METHOD)  ON UPDATE CASCADE,
				AMOUNT DECIMAL(18,2) NOT NULL,
				);

	DROP TABLE IF EXISTS OTHER_METHODS_SUMMARY;
	CREATE TABLE OTHER_METHODS_SUMMARY(
	ID INT PRIMARY KEY IDENTITY,
	METHOD VARCHAR(100)FOREIGN KEY  REFERENCES M_PAYMENTS(METHOD) ON UPDATE CASCADE,
	USERNAME VARCHAR(255) FOREIGN KEY REFERENCES ACCOUNTS(USERNAME) ON UPDATE CASCADE,
	AMOUNT DECIMAL(18,2) NOT NULL
	)
	...
	METHOD VARCHAR(100) NOT NULL REFERENCES M_PAYMENTS(METHOD) ON UPDATE CASCADE,
	AMOUNT DECIMAL(18,2) NOT NULL,
	TILL VARCHAR(100) NOT NULL REFERENCES TILLS(TILL_NUMBER) ON UPDATE CASCADE
);
