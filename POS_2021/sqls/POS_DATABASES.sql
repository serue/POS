...
CREATE TABLE TRANSACTIONS(
	...
	CASHIER VARCHAR(500) NOT NULL REFERENCES ACCOUNTS(USERNAME),
...
CREATE TABLE P_RETURNS(
	...
	BARCODE VARCHAR(50) REFERENCES TRANS_DETAILS(BARCODE),
	QUANTITY DECIMAL(18,2) NOT NULL,
	AMOUNT DECIMAL(18,2) NOT NULL,
	TRANSACTION_ID VARCHAR(100) NOT NULL REFERENCES TRANSACTIONS(TRANSACTION_ID),
...
CREATE TABLE USER_PERMISSIONS(
	ID INT IDENTITY(1,1) NOT NULL,
	EMP_ID VARCHAR(255) REFERENCES ACCOUNTS(EMP_ID) NOT NULL UNIQUE,
	USERNAME VARCHAR(500) NOT NULL REFERENCES ACCOUNTS(USERNAME),
...
INSERT INTO USERS(NAME,ID_NO,ADDRESS,GENDER,AGE,CONTACT,EMP_ID) VALUES('admin','admin','admin','male',1,'0777777');
INSERT INTO ACCOUNTS(EMP_ID,USERNAME,PASSWORD) VALUES('1','admin','4GecQ6hxhkk=');

INSERT INTO USER_PERMISSIONS(USERNAME,PERMISSION,STATUS) VALUES('admin','transaction_log',1);
INSERT INTO USER_PERMISSIONS(USERNAME,PERMISSION,STATUS) VALUES('admin','transaction_log',1);
INSERT INTO USER_PERMISSIONS(USERNAME,PERMISSION,STATUS) VALUES('admin','transaction_log',1);
INSERT INTO USER_PERMISSIONS(USERNAME,PERMISSION,STATUS) VALUES('admin','transaction_log',1);
INSERT INTO USER_PERMISSIONS(USERNAME,PERMISSION,STATUS) VALUES('admin','transaction_log',1);
