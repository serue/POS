...
Public Class transactio_logRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_2021.transactio_logRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtransactio_logRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As transactio_logRpt = New transactio_logRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
