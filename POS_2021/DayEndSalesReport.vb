...
Public Class DayEndSalesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_2021.DayEndSalesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDayEndSalesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DayEndSalesReport = New DayEndSalesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
